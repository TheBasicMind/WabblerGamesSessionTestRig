...
extension WabblerGameSession {
    ...
    mutating func saveGameData(_ gameData: GameData, completionHandler: @escaping (GameData?, Error?) -> Void) {
    ...
    mutating func loadGameData(completionHandler: @escaping (GameData?, Error?) -> Void) {
